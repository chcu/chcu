<div class="row callToAction">
	<div class="col-sm-12">
		...
		<p class="text-center donateButton">
			<a class="img" target="_blank" href="https://www.hithit.com/cs/project/793/chcu-zit-brno"><img class="img-responsive"> src="<?php echo get_theme_root_uri() . '/' . get_template() ?>/donate_button.png" /></a>
		</p>
	</div>
</div>
