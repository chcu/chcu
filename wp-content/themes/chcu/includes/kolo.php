					...
					<tr>
						<td>
							<form action="http://zitbrno.us9.list-manage1.com/subscribe?u=f43e55b146b360b0ac7653baf&id=c4f16f0d68" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
								...
								<table class="inputs">
									<tr>
										<td><input type="email" value="" name="EMAIL" placeholder="tvujhlas@volic.cz" /></td>
										<td><button type="submit" class="button">Chcu!</button></td>
									</tr>
								</table>
								<p class="hidden-xs">
...
<script type="text/javascript">
	$(function(){
		...
		function resizeKolo() {
			...
			//$('.kolo .content').css('height', $('.kolo').innerHeight() + 'px');
		}
